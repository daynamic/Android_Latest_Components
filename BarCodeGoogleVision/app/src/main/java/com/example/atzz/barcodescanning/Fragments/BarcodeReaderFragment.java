...
import com.example.atzz.barcodescanning.BarCode.BarcodeGraphic;
import com.example.atzz.barcodescanning.Tracker.BarcodeTrackerFactory;
import com.example.atzz.barcodescanning.Tracker.BarcodeGraphicTracker;
import com.example.atzz.barcodescanning.BarCode.ScannerOverlay;
import com.example.atzz.barcodescanning.camera.CameraSource;
import com.example.atzz.barcodescanning.camera.CameraSourcePreview;
import com.example.atzz.barcodescanning.camera.GraphicOverlay;
...
public class BarcodeReaderFragment extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.example.atzz.barcodescanning.R.layout.fragment_barcode_reader, container, false);
        permissionStatus = getActivity().getSharedPreferences("permissionStatus", getActivity().MODE_PRIVATE);
        mPreview = view.findViewById(com.example.atzz.barcodescanning.R.id.preview);
        mGraphicOverlay = view.findViewById(com.example.atzz.barcodescanning.R.id.graphicOverlay);
        mScanOverlay = view.findViewById(com.example.atzz.barcodescanning.R.id.scan_overlay);
        mScanOverlay.setVisibility(View.INVISIBLE);
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        autoFocus = a.getBoolean(com.example.atzz.barcodescanning.R.styleable.BarcodeReaderFragment_auto_focus, true);
        useFlash = a.getBoolean(com.example.atzz.barcodescanning.R.styleable.BarcodeReaderFragment_use_flash, false);
        a.recycle();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.CAMERA)) {
                ...
                builder.setTitle(getString(com.example.atzz.barcodescanning.R.string.grant_permission));
                builder.setMessage(getString(com.example.atzz.barcodescanning.R.string.permission_camera));
                builder.setPositiveButton(com.example.atzz.barcodescanning.R.string.grant, new DialogInterface.OnClickListener() {
                    @Override
                ...
                builder.setNegativeButton(com.example.atzz.barcodescanning.R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                        mListener.onCameraPermissionDenied();
    ...
    private void createCameraSource(final boolean autoFocus, final boolean useFlash) {
       // Log.e(TAG, "createCameraSource:");
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(getActivity(), com.example.atzz.barcodescanning.R.string.low_storage_error, Toast.LENGTH_LONG).show();
                Log.w(TAG, getString(com.example.atzz.barcodescanning.R.string.low_storage_error));
            }
        }
