...
/**
 * Created by asharm93 on 3/21/17.
 */
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.PhotoHolder> {
    ...
    public static class PhotoHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindPhoto(Photo photo) {
            ...
            String a=photo.getUrl();
            a=a.replace("http","https");
          //  a="https"+a;
            System.out.println(" the url is "+a+ "context "+mItemImage.getContext());
            Picasso.with(mItemImage.getContext()).load(a).into(mItemImage);
